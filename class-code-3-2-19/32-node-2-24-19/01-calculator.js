...
//   node calculator.js algebra 4x+2=10
	...
	var algebra_problem = process.argv[3]; //4x+2=10

	var x = algebra_problem.indexOf('x'); //index of x
	var coefficient = parseFloat(algebra_problem.slice(0,x)); //4

	var plus = algebra_problem.indexOf('+'); //index of +
	var equal = algebra_problem.indexOf('='); //index of =

	var intercept = parseFloat(algebra_problem.slice(plus+1, plus+2)); //2

	var result = parseFloat(algebra_problem.slice(equal+1)); //10
